    ...
    <>
        <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
            ...
            <div className='flex flex-col items-center justify-center'>
                <img src={assets.logotexts_med} alt="logo" className='w-[min(30vw, 250px)]' />
                <h1 className='text-white text-4xl'>Texts Chat App</h1>
            </div>
            ...
            <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
                ...
                {currState === 'Sign up' && isDataSubmitted && (
                        <textarea rows={4} onChange={(e)=> setBio(e.target.value)} value={bio} placeholder='Provide a short bio...' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'></textarea>
                    )
                }
