            ...
            <div className='pb-5'>
                ...
                <div className='flex justify-between itens-center'>
                    ...
                    <div className='relative py-2 group'>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block group-active:block transition-all duration-3000'>
