...
const Sidebar = () => {
  ...
  return (
    <>
        <div className={`bg-[#8185B2]/10 h-full p-5 rounded-2-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden": ""}`}>
            <div className='pb-5'>

                {/* Navbar of Sidebar */}
                <div className='flex justify-between itens-center'>
                    <div className='flex items-center gap-2'>
                        <img src={assets.textslogo} alt="logo" className='max-w-40'/>
                        <h2 className='font-bold'>Texts</h2>
                    </div>
                    <div className='relative py-2 group'>
                        <img src={assets.menu_icon} alt="menu" className='max-h-5 cursor-pointer' onClick={() => setOpen(!open)}/>
                        <div className={`absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100  ${open ? "block" : "hidden"}`}>
